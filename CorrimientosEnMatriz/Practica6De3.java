...
public class Practica6De3 {
    ...
    public static void eliminarDato(int[][] matrizDeEnteros) {
        try {
            BufferedReader entrada = new BufferedReader(new InputStreamReader(System.in));

            System.out.println("Indique el número de fila que desea modificar: ");
            int fila = Integer.valueOf(entrada.readLine());

            if (fila >= 0 && fila < MAXFILAS) {
                System.out.println("Indique el índice de la columna que desea eliminar (de 0 a 9): ");
                ...
                if (columna >= 0 && columna < MAXCOLUMNAS - 1) {
                    ...
                    matrizDeEnteros[fila][MAXCOLUMNAS - 1] = matrizDeEnteros[fila][columna-1]; // Duplicar el último elemento
                } else {
